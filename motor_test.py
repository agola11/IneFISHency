...
GPIO.setup(rd1, GPIO.OUT)
GPIO.setup(rd2, GPIO.OUT)
PWM.start(PWM_rear_drive,50)

GPIO.output(rd1, GPIO.HIGH)
GPIO.output(rd2, GPIO.LOW)
PWM.set_duty_cycle(PWM_rear_drive, 25) 
